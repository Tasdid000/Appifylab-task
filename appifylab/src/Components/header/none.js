                ...
                <div className="container _custom_container">
                    ...
                    <div className="_logo_wrap">
                        <Link className="navbar-brand" to="/feed">
                            <img src="/assets/logo.svg" alt="Buddy Script" className="_nav_logo" />
                        </Link>
                    </div>
                    ...
                    <div className="" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                            ...
                            <li className="nav-item _header_nav_item">
                                ...
                                >
                                    ...
                                    <div id="_notify_drop" className={`_notification_dropdown ${showNotify ? 'show' : ''}`}>
                                        {/* Full notification content from your HTML */}
                                            ...
                                            <div className="_notifications_all">
                                                ...
                                                <div className="_notification_box">
                                                    <div className="_notification_image">
                                                        <img src="/assets/friend-req.png" alt="Image" className="_notify_img" />
                                                    </div>
                            ...
                            {/* Chat */}
                            <li className="nav-item _header_nav_item">
                                <Link className="nav-link _header_nav_link" to="/chat">
                        ...
                        <div className="_header_nav_profile">
                            <div className="_header_nav_profile_image">
                                {user?.data?.image ? (
                                    <img src={`http://127.0.0.1:8000${user.data.image}`} alt="Profile" className="_nav_profile_img" />
                                ) : (
                            ...
                            <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${showProfile ? 'show' : ''}`}>
                                <div className="_nav_profile_dropdown_info">
                                    <div className="_nav_profile_dropdown_image">
                                        <img src={`http://127.0.0.1:8000${user.data.image}`} alt="Profile" className="_nav_drop_img" />
                                    </div>
                                    <div className="_nav_profile_dropdown_info_txt">
                                        <h4 className="_nav_dropdown_title">{user?.data?.first_name} {user?.data?.last_name}</h4>
                                ...
                                <ul className="_nav_dropdown_list">
                                    ...
                                    <li className="_nav_dropdown_list_item">
                                        <Link to="/help" className="_nav_dropdown_link">
                                            <div className="_nav_drop_info">
                                                <span>
