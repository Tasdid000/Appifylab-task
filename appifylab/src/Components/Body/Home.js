...
import { isAuthenticated } from '../Body/utils/auth';

const Home = () => {

  if (!isAuthenticated()) return <Navigate to="/login" />;
  return (
    <div className="container _custom_container px-20">
                ...
                <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                  ...
                  <ul className="_left_inner_area_explore_list">
                    <li className="_left_inner_area_explore_item _explore_item">
                      <Link to="/learning" className="_left_inner_area_explore_link">
                    ...
                    <li className="_left_inner_area_explore_item">
                      <Link to="/bookmarks" className="_left_inner_area_explore_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                    ...
                    <li className="_left_inner_area_explore_item">
                      <Link to="/groups" className="_left_inner_area_explore_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <li className="_left_inner_area_explore_item _explore_item">
                      <Link to="/gaming" className="_left_inner_area_explore_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                    ...
                    <li className="_left_inner_area_explore_item">
                      <Link to="/" className="_left_inner_area_explore_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 22 24" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="_layout_left_sidebar_inner">
                <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                  <div className="_left_inner_area_suggest_content _mar_b24">
                    ...
                    <Link to="/people" className="_left_inner_area_suggest_content_txt_link">See All</Link>
                  </div>
                  ...
                  <div className="_left_inner_area_suggest_info">
                    <div className="_left_inner_area_suggest_info_box">
                      <div className="_left_inner_area_suggest_info_image">
                        <Link to="/profile">
                          <img src="/assets/people1.png" alt="Steve Jobs" className="_info_img" />
                        </Link>
                      </div>
                  ...
                  <div className="_left_inner_area_suggest_info">
                    <div className="_left_inner_area_suggest_info_box">
                      <div className="_left_inner_area_suggest_info_image">
                        <Link to="/profile">
                          <img src="/assets/people2.png" alt="Ryan Roslansky" className="_info_img1" />
                        </Link>
                      </div>
                      <div className="_left_inner_area_suggest_info_txt">
                        <Link to="/profile">
                  ...
                  <div className="_left_inner_area_suggest_info">
                    <div className="_left_inner_area_suggest_info_box">
                      <div className="_left_inner_area_suggest_info_image">
                        <Link to="/profile">
                          <img src="/assets/people3.png" alt="Dylan Field" className="_info_img1" />
                        </Link>
                      </div>
                      <div className="_left_inner_area_suggest_info_txt">
                        <Link to="/profile">
              ...
              <div className="_layout_left_sidebar_inner">
                <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                  <div className="_left_inner_event_content">
                    ...
                    <Link to="/events" className="_left_inner_event_link">See all</Link>
                  </div>

                  <Link to="/event-single" className="_left_inner_event_card_link">
                    <div className="_left_inner_event_card">
                      <div className="_left_inner_event_card_iamge">
                        <img src="/assets/feed_event1.png" alt="Event" className="_card_img" />
                      </div>
              ...
              <div className="_layout_right_sidebar_inner">
                <div className="_right_inner_area_info _padd_t24 _padd_b24 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                  <div className="_right_inner_area_info_content _mar_b24">
                    ...
                    <Link to="/people" className="_right_inner_area_info_content_txt_link">See All</Link>
                  </div>
                  <hr className="_underline" />
                  <div className="_right_inner_area_info_ppl">
                    <div className="_right_inner_area_info_box">
                      <div className="_right_inner_area_info_box_image">
                        <Link to="/profile">
                          <img src="/assets/Avatar.png" alt="User" className="_ppl_img" />
                        </Link>
                      </div>
                ...
                <div className="_feed_right_inner_area_card _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                  <div className="_feed_top_fixed">
                    <div className="_feed_right_inner_area_card_content _mar_b24">
                      ...
                      <Link to="/find-friends" className="_feed_right_inner_area_card_content_txt_link">See All</Link>
                    </div>
                    <form className="_feed_right_inner_area_card_form">
                      ...
                      <input className="_feed_right_inner_area_card_form_inpt form-control me-2" type="search" placeholder="Search friends" />
                    </form>
                  </div>
                  ...
                  <div className="_feed_bottom_fixed">
                    <div className="_feed_right_inner_area_card_ppl _feed_right_inner_area_card_ppl_inactive">
                      <div className="_feed_right_inner_area_card_ppl_box">
                        <div className="_feed_right_inner_area_card_ppl_image">
                          <Link to="/profile">
                            <img src="/assets/people1.png" alt="" className="_box_ppl_img" />
                          </Link>
                        </div>
                    ...
                    <div className="_feed_right_inner_area_card_ppl">
                      <div className="_feed_right_inner_area_card_ppl_box">
                        <div className="_feed_right_inner_area_card_ppl_image">
                          <Link to="/profile">
                            <img src="/assets/people2.png" alt="" className="_box_ppl_img" />
                          </Link>
                        </div>
                        <div className="_feed_right_inner_area_card_ppl_txt">
                          <Link to="/profile">
                    ...
                    <div className="_feed_right_inner_area_card_ppl">
                      <div className="_feed_right_inner_area_card_ppl_box">
                        <div className="_feed_right_inner_area_card_ppl_image">
                          <Link to="/profile">
                            <img src="/assets/people3.png" alt="" className="_box_ppl_img" />
                          </Link>
                        </div>
                        <div className="_feed_right_inner_area_card_ppl_txt">
                          <Link to="/profile">
                    ...
                    <div
                      class="_feed_right_inner_area_card_ppl _feed_right_inner_area_card_ppl_inactive">
                      <div class="_feed_right_inner_area_card_ppl_box">
                        ...
                        <div class="_feed_right_inner_area_card_ppl_txt">
                          <a href="profile.html">
                            <h4 class="_feed_right_inner_area_card_ppl_title">Steve Jobs
                            </h4>
                          </a>
                          <p class="_feed_right_inner_area_card_ppl_para">CEO of Apple</p>
                        </div>
                      </div>
                      <div class="_feed_right_inner_area_card_ppl_side"> <span>5 minute
                        ago</span>
                      </div>
                    </div>
                    <div class="_feed_right_inner_area_card_ppl">
                      <div class="_feed_right_inner_area_card_ppl_box">
                        ...
                        <div class="_feed_right_inner_area_card_ppl_txt">
                          <a href="profile.html">
                            <h4 class="_feed_right_inner_area_card_ppl_title">Ryan
                              Roslansky</h4>
                          </a>
                          <p class="_feed_right_inner_area_card_ppl_para">CEO of Linkedin
                          </p>
                        </div>
                      </div>
                      <div class="_feed_right_inner_area_card_ppl_side">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                          ...
                          <rect width="12" height="12" x="1" y="1" fill="#0ACF83"
                            stroke="#fff" stroke-width="2" rx="6" />
                        </svg>
                      </div>
                    </div>
                    <div class="_feed_right_inner_area_card_ppl">
                      <div class="_feed_right_inner_area_card_ppl_box">
                        ...
                        <div class="_feed_right_inner_area_card_ppl_txt">
                          <a href="profile.html">
                            <h4 class="_feed_right_inner_area_card_ppl_title">Dylan
                              Field</h4>
                          </a>
